...
public interface DataLayerDemo {
     ...
     */
    Account loadAccount(final Long id);
    /**
     * Loads the given Object.
     * @param id Id to load
     ...
     */
    Address loadAddress(final Long id);
    /**
     * Loads the given Object.
     * @param id Id to load
     * @return An object of type T
     ...
     * @param id Identifier to delete
     */
    void deleteCustomerTransaction(final Long id);
     ...
     */
    CustomerTransaction loadCustomerTransaction(final Long id);
    /**
     * Loads the given Object.
     * @param id Id to load
     * @return An object of type T
     */
     CustomerTransaction getCustomerTransaction(final Long id);  
